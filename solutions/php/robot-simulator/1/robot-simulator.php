...
class Robot
{
    ...
    public static array $availableDirections = [
    ...
    public static array $availableInstructions = [
        self::TURN_LEFT,
        self::TURN_RIGHT,
        self::ADVANCE,
    ];
    ...
    {
        list($horisontal, $vertical) = $this->position;
        ...
        $this->position = [$horisontal, $vertical];
